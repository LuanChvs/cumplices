const CACHE_VERSION = 'cumplices-v30';
const CACHE_NAME = CACHE_VERSION;

const APP_FILES = [
  './', './index.html',
  './css/style.css', './css/games/conexao.css', './css/games/em-sintonia.css', './css/games/stop.css', './css/games/verdade.css', './css/games/quiz.css', './css/games/velha.css', './css/games/xadrez.css', './css/games/quem-sou-eu.css', './css/games/termo.css', './css/games/termo-versus.css', './css/games/forca.css',
  ...
  './js/games/conexao.js', './js/games/em-sintonia.js', './js/games/stop.js', './js/games/verdade.js', './js/games/quiz.js', './js/games/jogo-da-velha.js', './js/games/xadrez.js', './js/games/quem-sou-eu.js', './js/games/quem-sou-eu-layout.js', './js/games/forca-engine.js', './js/games/termo.js', './js/games/termo-versus.js', './js/games/forca.js',
