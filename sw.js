const CACHE_VERSION = 'cumplices-v15';
const CACHE_NAME = CACHE_VERSION;

const APP_FILES = [
  './', './index.html',
  './css/style.css', './css/games/conexao.css', './css/games/em-sintonia.css', './css/games/stop.css', './css/games/verdade.css', './css/games/quiz.css', './css/games/velha.css', './css/games/xadrez.css', './css/games/quem-sou-eu.css',
  ...
  './js/games/conexao.js', './js/games/em-sintonia.js', './js/games/stop.js', './js/games/verdade.js', './js/games/quiz.js', './js/games/jogo-da-velha.js', './js/games/xadrez.js', './js/games/quem-sou-eu.js', './js/games/quem-sou-eu-layout.js',
  './data/conexao.js', './data/em-sintonia.js', './data/verdades-desafios.js', './data/quiz-perguntas.js', './data/stop-temas.js', './data/jogo-da-velha.js', './data/quem-sou-eu.js',
