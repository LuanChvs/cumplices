const CACHE_VERSION = 'cumplices-v43';
...
const APP_FILES = [
  ...
  './js/games/conexao.js', './js/games/em-sintonia.js', './js/games/stop.js', './js/games/verdade.js', './js/games/quiz.js', './js/games/jogo-da-velha.js', './js/games/xadrez.js', './js/games/quem-sou-eu.js', './js/games/forca-engine.js', './js/games/termo.js', './js/games/termo-versus.js', './js/games/forca.js',
