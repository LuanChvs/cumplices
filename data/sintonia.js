...
window.DATA.sintonia = [
  { nome:"Memórias", cor:"var(--rose)", perguntas:[
    "Qual foi o momento em que você percebeu que estava apaixonado(a)?",
    "Qual é a lembrança mais engraçada que vocês têm juntos?",
    "Qual foi o encontro mais nervoso que vocês tiveram?",
    "Que música lembra o começo de vocês dois?",
    "Qual foi a primeira impressão que você teve do outro?",
  ...
  { nome:"Desejos", cor:"var(--gold)", perguntas:[
    ...
    "Qual é um sonho seu que o outro talvez não conheça?",
    "Se pudessem morar em qualquer lugar, onde seria?",
    "Qual experiência vocês querem viver juntos até o fim do ano?",
    "Existe algum hobby que você quer aprender ao lado do outro?",
  ...
  { nome:"Confissões", cor:"var(--teal)", perguntas:[
    ...
    "Qual é o hábito do outro que te irrita, mas você nunca falou?",
    "Já sentiu ciúmes de alguém sem motivo?",
    "Qual mentirinha branca você já contou pro seu par?",
    "Tem algo que você faz escondido que talvez o outro não saiba?",
  ...
  { nome:"Só rindo", cor:"var(--lav)", perguntas:[
    ...
    "Qual seria o apelido perfeito, e ridículo, pro outro?",
    "Se vocês virassem uma dupla de comediantes, qual seria o nome da dupla?",
    "Qual é a mania mais engraçada que o outro tem?",
    "Se seu par fosse um prato de comida, qual seria?",
  ...
  { nome:"Se pudesse", cor:"var(--coral)", perguntas:[
    ...
    "Se pudessem ganhar uma viagem grátis amanhã, pra onde iriam?",
    "Se tivessem que abandonar tudo e recomeçar em outra cidade, qual escolheriam?",
    "Se pudesse mudar uma coisa na rotina de vocês, o que seria?",
    "Se ganhassem um dinheiro alto hoje, no que gastariam primeiro?",
  ...
  { nome:"Daqui a 10 anos", cor:"var(--sage)", perguntas:[
    ...
    "Que tradição vocês gostariam de criar como casal?",
    "Qual conquista vocês querem comemorar juntos no futuro?",
    "Como acham que vão estar comemorando o aniversário de namoro daqui a uma década?",
    "Que conselho vocês dariam pro casal que eram no início do relacionamento?",
